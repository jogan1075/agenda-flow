        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-semibold text-slate-900">AgendaFlow se adapta a tu industria</h1>
            </div>
          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-3">
            {[
              ...
              <div key={group.title} className="rounded-3xl border border-slate-100 bg-slate-50/60 p-6 shadow-sm">
